...
<pre style="position: relative;"><strong>Input:</strong> text = "nlaebolko"
...
<pre style="position: relative;"><strong>Input:</strong> text = "loonbalxballpoon"
<strong>Output:</strong> 2
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> text = "leetcode"
